...
public class GUI {
	...
	private void initialize() {
		...
		ImageIcon start_img = new ImageIcon(".\\src\\start.png");
		...
		comboBox_6.addItem("Patrunjel");
		comboBox_6.addItem("Coriandru");
		comboBox_6.addItem("Marar");
		...
		JMenu Menu = new JMenu("Select meniu");
		Menu.setVisible(false);
		menuBar.add(Menu);

		JButton menuPredefinit = new JButton("Predefinit");
		Menu.add(menuPredefinit);

		JButton menuCostum = new JButton("Costum");
		Menu.add(menuCostum);
		...
		JButton start_screen = new JButton(start_img);
		start_screen.setContentAreaFilled(false);
		
		start_screen.addActionListener(new ActionListener() {
		...
		start_screen.setBounds(-19, -31, 678, 713);
		frame.getContentPane().add(start_screen);
